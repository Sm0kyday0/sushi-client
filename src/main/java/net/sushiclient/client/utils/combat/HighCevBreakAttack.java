...
public class HighCevBreakAttack implements Comparable<HighCevBreakAttack> {
    ...
    public HighCevBreakAttack(BlockPos crystalPos, BlockPos obsidianPos, EntityPlayer player, EntityPlayer target, EntityEnderCrystal crystal, double damage, boolean crystalPlaced, boolean obsidianPlaced) {
    ...
    @Override
    public int compareTo(HighCevBreakAttack o) {
